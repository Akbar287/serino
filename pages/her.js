...
import Her from "../public/assets/HerHeader_bg.png"
import {getHerCategory} from "./api/_api"
import Link from 'next/link'
import { AnimatePresence, motion } from 'framer-motion'
function her() {
  const herProduct = getHerCategory()
  const headerAnimate ={
    initial: {
      y: -100,
      opacity: 0
  ...
  return (
    <Layout title="For Her">
        <motion.div variants={headerAnimate} initial="initial" animate="visible" className="height-category relative">
          <Image src={Her} alt="Header Her" className="w-full h-auto" layout="responsive" width={1920} height={592} />
          <div className="mb-6 pt-32 lg:pt-52 z-10 top-0 right-0 left-0 absolute w-full text-center flex flex-col items-center justify-center text-white">
